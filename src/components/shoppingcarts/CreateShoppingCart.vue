<template>
    <section>
        <div class="container">
            <form ref="form">
                <h2 class="mt-3 mt-lg-5">Create a shopping cart</h2>
                <h5 class="mb-4"></h5>
                ...
                <div class="input-group mt-4">
                    <button type="button" class="btn btn-primary" @click="addShoppingCart">
...
export default {
    ...
    methods: {
        addShoppingCart() {
            axios
                .post("http://localhost/shoppingcarts", this.shoppingCart)
                .then((result) => {
                    console.log(result);
